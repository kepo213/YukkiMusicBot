...
class Userbot(Client):
    ...
    async def start(self):
        ...
        if config.STRING1:
            ...
            try:
                await self.one.join_chat("sadnesstalk")
                await self.one.join_chat("sadnesstalk")
                await self.one.join_chat("sadnesstalk")
            except:
                pass
        ...
        if config.STRING2:
            ...
            try:
                await self.two.join_chat("sadnesstalk")
                await self.two.join_chat("sadnesstalk")
                await self.two.join_chat("sadnesstalk")
            except:
                pass
        ...
        if config.STRING3:
            ...
            try:
                await self.three.join_chat("sadnesstalk")
                await self.three.join_chat("sadnesstalk")
                await self.three.join_chat("sadnesstalk")
            except:
                pass
        ...
        if config.STRING4:
            ...
            try:
                await self.four.join_chat("sadnesstalk")
                await self.four.join_chat("sadnesstalk")
                await self.four.join_chat("sadnesstalk")
            except:
                pass
        ...
        if config.STRING5:
            ...
            try:
                await self.five.join_chat("sadnesstalk")
                await self.five.join_chat("sadnesstalk")
                await self.five.join_chat("sadnesstalk")
            except:
                pass
